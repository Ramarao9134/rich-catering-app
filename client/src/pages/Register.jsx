  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden" style={{ boxShadow: '0 0 30px rgba(251, 191, 36, 0.3)' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[750px] lg:min-h-[800px]">
          {/* Left Side - Welcome Message with Footer Info */}
          <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 p-6 lg:p-8 flex flex-col justify-between text-white relative overflow-hidden order-2 lg:order-1">
            <div className="absolute top-0 right-0 w-0 h-0 border-t-[800px] border-r-[100px] border-t-transparent border-r-gray-900 opacity-10"></div>
              ...
              <div className="flex-shrink-0">
                ...
                <div className="space-y-2.5 mb-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-white/90">Create your account in seconds</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-white rounded-full flex-shrink-0"></div>
                    <span className="text-sm text-white/90">Start ordering delicious food</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-white rounded-full flex-shrink-0"></div>
                    <span className="text-sm text-white/90">Book events and parties</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-white rounded-full flex-shrink-0"></div>
                    <span className="text-sm text-white/90">Track all your orders</span>
                  </div>
                </div>
          ...
          <div className="bg-gray-900 p-8 lg:p-12 flex flex-col justify-center relative order-1 lg:order-2">
            <div className="absolute top-0 left-0 w-0 h-0 border-b-[800px] border-l-[100px] border-b-transparent border-l-orange-500 opacity-20"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-white mb-2 text-sm font-medium">Address (Optional)</label>
                <textarea
                  name="address"
                  value={formData.address}
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-gray-800 border-b-2 border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-orange-500 transition-colors resize-none"
                  rows="3"
            ...
            <p className="mt-6 text-center text-gray-400">
              ...
              <Link to="/login" className="text-orange-500 hover:text-orange-400 font-semibold underline">
                Sign In
              </Link>
            </p>
          </div>
